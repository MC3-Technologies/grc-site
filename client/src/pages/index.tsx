          ...
          <div className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow p-5   dark:border-gray-700 dark:bg-gray-800 ">
            ...
            <div className="items-center justify-center space-y-3 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse">
              <a
                ...
                className="font-semibold w-full sm:w-auto bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 text-white rounded-lg inline-flex items-center justify-center px-3 py-2 dark:bg-primary-700 dark:hover:bg-primary-600 dark:focus:ring-primary-700"
              >
                <svg
