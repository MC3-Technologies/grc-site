    ...
    <div>
      ...
      <div className="p-4 mb-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800">
        ...
        <p className="mt-1 text-gray-600 dark:text-gray-400">
          You have {stats.pendingUsers} pending user approval{stats.pendingUsers !== 1 ? "s" : ""} and{" "}
          {stats.totalAssessments.inProgress} in-progress assessment{stats.totalAssessments.inProgress !== 1 ? "s" : ""}.
        </p>
      </div>
        ...
        <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-semibold text-gray-900 dark:text-white">
                {stats.totalAssessments.inProgress + stats.totalAssessments.completed}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          This section will display recent user registrations, assessment completions, and other
          activity. This will be implemented in a future milestone.
        </p>
      </div>
    </div>
  );
