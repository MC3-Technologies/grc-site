...
const cmmcLevel1Data: CmmcLevel1Control[] = [
  {
    ...
    remediationGuidance:
      "Review accounts and devices regularly. Disable unused accounts and restrict system access to known devices.",
  ...
  },
  {
    ...
    remediationGuidance:
      "Set up role-based access, remove unnecessary admin rights, and review privileges periodically.",
    evidence:
      "User roles list, screenshots of account types, least privilege policy.",
  ...
  },
  {
    ...
    plainEnglish:
      "Limit use of external systems and services to those you trust and authorize.",
    assessmentQuestions: [
    ...
    remediationGuidance:
      "Use firewall rules, policies, or approvals to control connections.",
  ...
  },
  {
    ...
    plainEnglish:
      "Every user, process, and device must be uniquely identified.",
    assessmentQuestions: [
    ...
    remediationGuidance:
      "Remove shared accounts, maintain user/device/cloud inventory.",
  ...
  },
  {
    ...
    plainEnglish:
      "Users and devices must prove who they are before access is granted.",
    assessmentQuestions: [
    ...
    remediationGuidance:
      "Enable password/MFA, restrict personal devices, enforce authentication across systems.",
  ...
  },
  {
    ...
    remediationGuidance:
      "Use disk wipe tools, shredding services, paper shredders.",
  ...
  },
  {
    ...
    plainEnglish:
      "Lock down office/WFH spaces so only authorized staff can access systems.",
    assessmentQuestions: [
    ...
    remediationGuidance:
      "Use locks, keycards, restrict device use in WFH setups.",
  ...
  },
  {
    ...
    remediationGuidance:
      "Maintain sign-in logs, escort visitors, apply WFH visitor rules.",
  ...
  },
  {
    ...
    requirement:
      "Monitor, control, and protect organizational communications at the external and key internal boundaries of information systems.",
    plainEnglish:
      "Use firewalls or router/device protections to control traffic.",
    assessmentQuestions: [
    ...
    remediationGuidance:
      "Enable router/device firewalls, VPN, SSL/TLS. Hardware firewall optional.",
  ...
  },
  {
    ...
    plainEnglish:
      "Keep public-facing systems separate from internal FCI systems.",
    assessmentQuestions: [
    ...
    remediationGuidance:
      "Host websites externally, use guest/DMZ networks, configure cloud separation.",
  ...
  },
  {
    ...
    remediationGuidance:
      "Enable auto-updates, track patches in logs/spreadsheets.",
  ...
  },
  {
    ...
    plainEnglish:
      "Install and maintain antivirus/endpoint protection everywhere.",
    assessmentQuestions: [
    ...
    remediationGuidance:
      "Install antivirus, enable auto-updates, use cloud email protection.",
  ...
  },
  {
    ...
    plainEnglish:
      "Ensure antivirus and malware protections are always current.",
    assessmentQuestions: [
    ...
    remediationGuidance:
      "Configure auto-updates, check logs, rely on vendor-managed cloud protections.",
  ...
  },
  {
    ...
    plainEnglish:
      "Run scheduled scans and real-time scans for files and downloads.",
    assessmentQuestions: [
    ...
    remediationGuidance:
      "Enable daily/weekly scans, ensure AV scans files in real time.",
  ...
  },
  {
    ...
    plainEnglish:
      "Maintain an inventory of systems, software, and their baseline settings.",
    assessmentQuestions: [
    ...
    remediationGuidance:
      "Create asset inventory, document baseline configurations, update as systems change.",
  ...
  },
  {
    ...
    requirement:
      "Screen individuals prior to authorizing access to organizational information systems containing Federal Contract Information.",
    plainEnglish:
      "Screen employees (background/reference checks) before giving access to systems with FCI.",
    assessmentQuestions: [
    ...
    remediationGuidance:
      "Use HR services for background checks, link screening to account creation process.",
