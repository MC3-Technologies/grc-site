...
describe("Cognito Admin Utils Additional Tests", () => {
  ...
  describe("rejectUser", () => {
    it("should return success in development mode", async () => {
      ...
      const result = await cognitoAdmin.rejectUser(
        "user@example.com",
  ...
  describe("suspendUser", () => {
    it("should return success in development mode", async () => {
      ...
      const result = await cognitoAdmin.suspendUser(
        "user@example.com",
  ...
  describe("helper functions", () => {
    ...
    it("should fetch user details in development mode via _getUserDetailsDevelopment", async () => {
      ...
      const result =
        await cognitoAdmin._getUserDetailsDevelopment("test@example.com");
    ...
    it("should handle errors in _getUserDetailsDevelopment", async () => {
      ...
      const result = await cognitoAdmin._getUserDetailsDevelopment(
