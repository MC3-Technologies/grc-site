  ...
  pages: [
    {
      ...
      elements: [
        ...
        },
        {
          ...
          visibleIf: "{it_policies} = 'yes'",
          choices: [
            { value: "new_employee_handbook", text: "New Employee Handbook / Guide" },
        ...
        {
          name: "remote_access",
          title: "Do employees have remote access to company resources to perform their work?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
    ...
    },
    {
      ...
      elements: [
        ...
        },
        {
          ...
          title: "Do you have a process to secure user account credential changes (password, username change)?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
        ...
        },
        {
          ...
          title: "Does each employee have a unique account and access only to the company resources they need for their role?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
        ...
        },
        {
          ...
          title: "Do you have separate accounts for Privileged or Admin Accounts?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
        ...
        },
        {
          ...
          title: "Do you ensure that account details like usernames and passwords are protected from misuse?",
          type: "radiogroup",
          isRequired: true,
    ...
    },
    {
      ...
      elements: [
        ...
        },
        {
          ...
          title: "Do employees sign an agreement on the proper use of company assets?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
        ...
        {
          name: "asset_disposal",
          title: "How do you dispose of assets when they reach their end of life (EOL)?",
          type: "comment",
          isRequired: true
        },
        {
        ...
        },
        {
          ...
          title: "Do you sanitize/destroy old assets, media, or documents in your business?",
          type: "radiogroup",
          isRequired: true,
      ...
      elements: [
        {
          ...
          title: "Do you have an established Business Continuity Plan in case of a disaster?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
        ...
        {
          name: "bcp_training",
          title: "If yes: Do you train employees on proper roles and responsibilities?",
          type: "radiogroup",
          isRequired: true,
      ...
      elements: [
        {
          ...
          title: "What steps do you take to ensure the security of payment systems and keep your software and systems updated against vulnerabilities?",
          type: "comment",
          isRequired: true
        },
        {
        ...
        },
        {
          ...
          title: "Are all devices that accept credit card payments secured from tampering & skimming?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
    ...
    },
    {
      ...
      elements: [
        ...
        },
        {
          ...
          title: "Do employees have the ability to download and install any software (SW) they want?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
      ...
      elements: [
        {
          ...
          title: "Do you have any processes to protect sensitive data during transmission & storage?",
          type: "comment",
          isRequired: true,
        ...
        },
        {
          ...
          title: "Do you have the ability to remotely wipe company assets that employees use for work?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
      ...
      elements: [
        {
          ...
          title: "Do you have a process in place to ensure your domain registration does not lapse/expire?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
      ...
      elements: [
        {
          ...
          title: "Does the company own all computers/laptops/workstations/mobile devices?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
        ...
        },
        {
          ...
          type: "radiogroup",
          isRequired: true,
          description: "Example: AV, Firewall, inactivity timeout, Auto updates, etc.",
          choices: [
            { value: "yes", text: "Yes" },
            { value: "no", text: "No" }
          ]
        ...
        },
        {
          ...
          title: "Do you use a unique, strong local admin password for each workstation?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
        ...
        },
        {
          ...
          title: "Are there documented policies and procedures for using mobile devices in the organization?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
    ...
    },
    {
      ...
      elements: [
        ...
        },
        {
          ...
          title: "Are there formal procedures for employees to report cybersecurity incidents?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
        ...
        },
        {
          ...
          title: "Is there a process to identify potentially disgruntled employees that pose a risk to your company?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
      ...
      elements: [
        {
          ...
          title: "Do you have any tools or procedures to prepare, detect, and react to a cyber-attack?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
        ...
        },
        {
          ...
          title: "Do you have a process for notifying all affected parties in case of a cyber-attack?",
          type: "comment",
          isRequired: true,
          description: "Example: customers, law enforcement, shareholders, regulatory agencies, etc."
        },
        {
        ...
        },
        {
          ...
          title: "If yes: Have you reviewed and improved your incident response process after a successful cyber-attack?",
          type: "radiogroup",
          isRequired: true,
      ...
      elements: [
        {
          ...
          title: "Is there a formal Cybersecurity program in place, and does it have an information security policy in place?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
        ...
        },
        {
          ...
          title: "If yes: Are roles and responsibilities clearly outlined for individuals within the organization?",
          type: "radiogroup",
          isRequired: true,
      ...
      elements: [
        {
          ...
          title: "Does the company have security measures in place to protect its systems and sensitive information, and has it identified the most important ones?",
          type: "comment",
          isRequired: true
        },
        {
          name: "maintenance_monitoring",
          title: "Is maintenance of systems and infrastructure monitored and controlled?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
        ...
        },
        {
          ...
          title: "Do all systems and software receive the latest vendor-supplied security patches installed?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
      ...
      elements: [
        {
          ...
          title: "Are strong password (14+ complex characters or longest allowed) policies enforced across the organization?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
        ...
        },
        {
          ...
          title: "If yes: Is the password policy enforced on all company assets?",
          type: "radiogroup",
          isRequired: true,
      ...
      elements: [
        {
          ...
          title: "Do you have measures in place to control physical access to your company’s site?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
        ...
        },
        {
          ...
          description: "Example: Physical locks, PIN or swipe, CCTV, Security guard, alarm system, etc."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      elements: [
        ...
        {
          name: "vendor_vetting",
          title: "Do you vet them to ensure that they are reputable and have security measures in place?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
    ...
    },
    {
      ...
      elements: [
        ...
        },
        {
          ...
          title: "If yes: Do you handle sensitive customer data? (PII, PHI, CHD, etc.)",
          type: "radiogroup",
          isRequired: true,
          visibleIf: "{website_existence} = 'yes'",
          choices: [
        ...
        },
        {
          ...
          title: "Do you use a third-party service provider for financial data or payment processing?",
          type: "radiogroup",
          isRequired: true,
          choices: [
            { value: "yes", text: "Yes" },
